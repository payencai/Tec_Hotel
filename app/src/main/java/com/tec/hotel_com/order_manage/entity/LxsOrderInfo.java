...
/**
 * 作者：凌涛 on 2018/10/17 18:02
 * 邮箱：771548229@qq..com
 */
public class LxsOrderInfo extends RVBaseCell {
    ...
    public RVBaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_lxs_orderinfo_rv_layout, parent, false);
    ...
    public void onBindViewHolder(RVBaseViewHolder holder, int position, final Context context, RVBaseAdapter adapter) {
        ...
        holder.getView(R.id.item).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                UserHotelOrderDetailActivity.startHotelOrderDetailActivity(context, id,2);
            }
        });
